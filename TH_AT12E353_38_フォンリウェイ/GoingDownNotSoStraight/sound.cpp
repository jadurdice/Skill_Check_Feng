...
namespace
{
    const char ArchiveRelativePath[] = "sankou.bfsar";
...
void InitSound()
{
	...
	// SoundData読み込み
	{
		...
		//↓ここに追加
		isSuccess = g_SoundDataManager.LoadData(S_JUMP, &g_SoundHeap); NN_ABORT_UNLESS(isSuccess, "LoadData failed.");
		isSuccess = g_SoundDataManager.LoadData(S_CANCEL, &g_SoundHeap); NN_ABORT_UNLESS(isSuccess, "LoadData failed.");
		isSuccess = g_SoundDataManager.LoadData(S_CLICK, &g_SoundHeap); NN_ABORT_UNLESS(isSuccess, "LoadData failed.");
		isSuccess = g_SoundDataManager.LoadData(S_CLOSE, &g_SoundHeap); NN_ABORT_UNLESS(isSuccess, "LoadData failed.");
		isSuccess = g_SoundDataManager.LoadData(S_DAMAGE, &g_SoundHeap); NN_ABORT_UNLESS(isSuccess, "LoadData failed.");
		isSuccess = g_SoundDataManager.LoadData(S_DECIDE_, &g_SoundHeap); NN_ABORT_UNLESS(isSuccess, "LoadData failed.");
		isSuccess = g_SoundDataManager.LoadData(S_ENEMY, &g_SoundHeap); NN_ABORT_UNLESS(isSuccess, "LoadData failed.");
		isSuccess = g_SoundDataManager.LoadData(S_LADDER, &g_SoundHeap); NN_ABORT_UNLESS(isSuccess, "LoadData failed.");
		isSuccess = g_SoundDataManager.LoadData(S_LAND, &g_SoundHeap); NN_ABORT_UNLESS(isSuccess, "LoadData failed.");
		isSuccess = g_SoundDataManager.LoadData(S_OPEN, &g_SoundHeap); NN_ABORT_UNLESS(isSuccess, "LoadData failed.");
		isSuccess = g_SoundDataManager.LoadData(S_PUTBACK, &g_SoundHeap); NN_ABORT_UNLESS(isSuccess, "LoadData failed.");
		isSuccess = g_SoundDataManager.LoadData(S_STRECH, &g_SoundHeap); NN_ABORT_UNLESS(isSuccess, "LoadData failed.");
		isSuccess = g_SoundDataManager.LoadData(S_TOUCHCELL, &g_SoundHeap); NN_ABORT_UNLESS(isSuccess, "LoadData failed.");
		isSuccess = g_SoundDataManager.LoadData(S_WRONG, &g_SoundHeap); NN_ABORT_UNLESS(isSuccess, "LoadData failed.");
		isSuccess = g_SoundDataManager.LoadData(S_GETMAP, &g_SoundHeap); NN_ABORT_UNLESS(isSuccess, "LoadData failed.");
		isSuccess = g_SoundDataManager.LoadData(S_OPENBOX, &g_SoundHeap); NN_ABORT_UNLESS(isSuccess, "LoadData failed.");
		isSuccess = g_SoundDataManager.LoadData(S_SWAP, &g_SoundHeap); NN_ABORT_UNLESS(isSuccess, "LoadData failed.");
	}
